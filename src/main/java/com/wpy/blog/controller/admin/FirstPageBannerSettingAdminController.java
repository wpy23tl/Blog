 ...
 */
@Controller
@RequestMapping("/firstPageBannerSettingAdminController")
public class FirstPageBannerSettingAdminController {
     ...
     */
    @RequestMapping("/save")
    public Response save(HttpServletRequest request, HttpServletResponse response, Model model, String id, MultipartFile pictureFile1) throws Exception {
