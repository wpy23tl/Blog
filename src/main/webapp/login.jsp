...
<TITLE>登录页面</TITLE>
<script type="text/javascript" src="${pageContext.request.contextPath}/loginResources/js/jquery-1.9.1.min.js"></script>
<STYLE>
    body {
        background: #ebebeb;
    ...
    * {
    ...
    .u_logo {
        background: url("${pageContext.request.contextPath}/loginResources/images/username.png") no-repeat;
        padding: 10px 10px;
        position: absolute;
        top: 43px;
        left: 40px;
    ...
    .p_logo {
        background: url("${pageContext.request.contextPath}/loginResources/images/password.png") no-repeat;
        padding: 10px 10px;
        position: absolute;
        top: 12px;
        left: 40px;
    ...
    .tou {
        background: url("${pageContext.request.contextPath}/loginResources/images/tou.png") no-repeat;
        width: 97px;
        height: 92px;
        position: absolute;
        top: -87px;
    ...
    .left_hand {
        background: url("${pageContext.request.contextPath}/loginResources/images/left_hand.png") no-repeat;
        width: 32px;
        height: 37px;
        position: absolute;
        top: -38px;
    ...
    .right_hand {
        background: url("${pageContext.request.contextPath}/loginResources/images/right_hand.png") no-repeat;
        width: 32px;
        height: 37px;
        position: absolute;
        top: -38px;
    ...
    .initial_left_hand {
        background: url("${pageContext.request.contextPath}/loginResources/images/hand.png") no-repeat;
        width: 30px;
        height: 20px;
        position: absolute;
        top: -12px;
    ...
    .left_handing {
        background: url("${pageContext.request.contextPath}/loginResources/images/left-handing.png") no-repeat;
        width: 30px;
        height: 20px;
        position: absolute;
        top: -24px;
    ...
    .right_handinging {
        background: url("${pageContext.request.contextPath}/loginResources/images/right_handing.png") no-repeat;
        width: 30px;
        height: 20px;
        position: absolute;
        top: -21px;
...
<form action="${pageContext.request.contextPath}/userController/login.do" method="post">
    <DIV style="background: rgb(255, 255, 255); margin: -100px auto auto; border: 1px solid rgb(231, 231, 231); border-image: none; width: 400px; height: 220px; text-align: center;">
        ...
        <P style="padding: 30px 0px 10px; position: relative;">
            <SPAN class="u_logo"></SPAN> <INPUT class="ipt" id="userName" name="userName" type="text" placeholder="请输入用户名"  value="">
        </P>
